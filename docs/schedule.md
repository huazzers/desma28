...
|     |TUESDAY   | THURSDAY   |
| --- | --------- | ----------------- |
| W0  |   | **09/24**<br><p>Introductions + Syllabus Overview</p><p>Workshop I: Instruction Drawing</p><p>Lecture: Thinking in Code</p><p>Workshop II: Intro to Processing</p><div class="assign"><p>▶️ ASSIGN:</p><ul><li>Reading + Media 1 (Due: W1 Tue, 09/29)</li><li>Exercise: Instruction + Object Research (Due: W1 Tue, 09/29)</li></ul></div>    |
